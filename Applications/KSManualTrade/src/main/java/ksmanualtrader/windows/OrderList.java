...
public class OrderList extends JFrame {
    ...
    public OrderList(ArrayList<Order> initialList, TraderDriverManifestV1 driver) {
        this.orders.clear();
...
class OrderRow extends JPanel {
    ...
    public OrderRow(TraderDriverV1 driver, Order order, int rowWidth, int rowHeight) {
        this.order = order;
        this.driver = driver;
    }
}
